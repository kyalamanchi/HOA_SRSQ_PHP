                ...
                <div class="row text-center">
                  ...
                  <?php 
                    ...
                    { 
                      ...
                      curl_setopt($ch, CURLOPT_CUSTOMREQUEST , 'GET');
                      curl_setopt($ch, CURLOPT_HTTPHEADER, array('User-Agent:Intuit-qbov3-postman-collection1','Accept:application/json','Authorization:OAuth oauth_consumer_key="qyprd0JzDPeMNuATqXcic8hnusenW2",oauth_token="QQPtfkL4fGZhVCUirhuwS7B7SxF1punukBhSjYPv",oauth_signature_method="HMAC-SHA1",oauth_timestamp="1497429042",oauth_nonce="zoRTBwG53rl",oauth_version="1.0",oauth_signature="KrrTrLBiDOUerb3%2Fticzvo%2F0HTI%3D'));
                      curl_setopt($ch, CURLOPT_RETURNTRANSFER, TRUE);
