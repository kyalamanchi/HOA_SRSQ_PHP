<?php
	...
	if($num_row == 0)
	{
		...
		echo 'window.location.href = "https://www.hoaboardtime.com/";';
		echo '</script>';
	}
	else
	{
		...
		if(password_verify($login_password, $password))
		{
			...
			if($_SESSION['hoa_user_id'] == 400)
			{
				...
				header("Location: https://www.hoaboardtime.com/backendBalance.php");
			...
			else
			{
				...
				if($num_row == 0)
					header("Location: https://www.hoaboardtime.com/residentDashboardTest.php");
				else
					header("Location: https://www.hoaboardtime.com/boardDashboardTest.php");
