        ...
        <section class="content">
          ...
          <?php
            ...
            if($community_id == 2)
            {
              ...
              $ch = curl_init('https://api.surveymonkey.net/v3/surveys');         
              ...
              foreach ($response_JSON_Decode['data'] as $data) {
                ...
                echo '<a href="https://hoaboardtime.com/boardSurveyDetails2.php?id='.$var.'" class="list-group-item"><h5 class="list-group-item-heading" style="color: green;">'.$data['title'].'</h5></a>';
