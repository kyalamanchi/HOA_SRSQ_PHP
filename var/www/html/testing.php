<?php
    ...
    for($m = 1; $m <= 12; $m++)
    {
        ...
        while($charges_row = pg_fetch_assoc($charges_results))
        {
            ...
            $pdf->Cell(20, 5, $charges_row['id']."-".$charges_row['assessment_rule_type_id'], 0, 0, 'L');
        ...
        while($payments_row = pg_fetch_assoc($payments_results))
        {
            ...
            $pdf->Cell(20, 5, date('F', strtotime($tdate)), 0, 0, 'L');
            $pdf->Cell(20, 5, $payments_row['id']."-".$payments_row['payment_type_id'], 0, 0, 'L');
