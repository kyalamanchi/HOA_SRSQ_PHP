...
$megaSignAgreementsQuery  = "SELECT * FROM COMMUNITY_SIGN_AGREEMENTS WHERE IS_MEGA_SIGN_AGREEMENT IS TRUE AND COMMUNITY_ID = 1";
    ...
    if($megaSignAgreements->code){
        ...
        foreach ($megaSignAgreements->megaSignChildAgreementList as $megaSignChildAgreementsDetails) {
            if ( $megaSignAgreementsArray[$megaSignChildAgreementsDetails->agreementId] ){
                ...
                curl_setopt($agreeementCURL, CURLOPT_HTTPHEADER, array('Access-Token:3AAABLblqZhBWF9BYTpVk2qiLdux9HoMp6296MnQhdvuw5sR-wRF84ZkKs3rUG6GDbSI8MVYE2-Kgabac7qiVa1FqAytq957r'));
