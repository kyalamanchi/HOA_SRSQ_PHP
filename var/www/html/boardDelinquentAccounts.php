                      ...
                      <?php 
                        ...
                        while($row = pg_fetch_assoc($result))
                        {
                          ...
                          if($del_amount <= ($assessment_charges - $payments) && $balance >= $del_amount)
                            echo "<tr><td><a href='https://hoaboardtime.com/boardUserDashboard2.php?hoa_id=$hoa_id'>".$firstname." ".$lastname."</a></td><td> ".$address1."</td><td>$ ".$balance."</td><td>".$cell_no."</td><td>".$email."</td></tr>";
