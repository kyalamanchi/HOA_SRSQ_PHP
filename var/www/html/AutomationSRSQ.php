...
function hidePleaseWait() {
    ...
    function updateAgreements(){
        ...
        var url = "https://hoaboardtime.com/automationBackgroundHandlerSRSQ.php?id=2";
        var source = new EventSource(url);
        source.onmessage  = function(e){
            if ( e.data == "Done!!!"){
                source.close();
    ...
    function updateBillingStatements(){
        ...
        var url = "https://hoaboardtime.com/automationBackgroundHandlerSRSQ.php?id=3";
        var source = new EventSource(url);
        source.onmessage  = function(e){
            if ( e.data == "Done!!!"){
                source.close();
    ...
    function updateAll(){
      ...
      request.open("POST","https://hoaboardtime.com/automationBackgroundHandlerSRSQ.php",true);
      request.send(null);
  ...
  function updateEmailsSent(){
    ...
    document.getElementById("emailResult").innerHTML = "";
        var url = "https://hoaboardtime.com/automationBackgroundHandlerSRSQ.php?id=4";
        var source = new EventSource(url);
        source.onmessage  = function(e){
            if ( e.data == "Done!!!"){
              source.close();
