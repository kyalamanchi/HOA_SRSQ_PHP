...
$pdf->SetFont('Arial','',8);
$pdf->MultiCell(0,3,'name'."\n".'name'."\n".'name'." ".'name',0,'0',false);
$pdf->Ln();
$pdf->SetX(113);
$pdf->SetWidths(array(40,50));
$pdf->SetTextColor(0,0,0);
$pdf->SetFont('Arial','B',9);
$pdf->Row(array('Account Number','123'));
$pdf->SetX(113);
$pdf->Row(array('Community ID','123'));
$pdf->SetX(113);
$pdf->Row(array('Property Address','123'));
$pdf->SetX(113);
$pdf->Row(array('Violation Notice ID','123'));
$pdf->SetX(113);
$pdf->Row(array('Notice Type', '123'));
$pdf->Ln();
$pdf->SetY(52.5);
$pdf->MultiCell(0,6,'name'." ".'name'." OR Current Resident",0,'0',false);
$pdf->SetFont('','',9);
$pdf->MultiCell(0,3.5,'name'."\n".'name'.", ".'name'.",".'name'."\n\n\n".date('M d,Y',strtotime('name'))."",0,'0',false);
$pdf->SetFont('','B',9);
$pdf->MultiCell(0,3.5,"\n\nRE: ".'name'." ",0,'0',false);
$pdf->SetFont('','',9);
$pdf->MultiCell(0,3.5,"\n\nDear ".'name'." ".'name'." OR Current Resident:\n\n".'name'." is a planned community governed by covenants, conditions and restrictions. Compliance with these rules benefits the entire community and all property owners are responsible for protecting the aesthetics and harmony of the neighborhood.
\n\nBy now you have probably already corrected the following issue at ".'name'.". If not, then this is a courtesy reminder from Stoneridge Square.\n\nIt has been reported or observed during a routine site inspection on ".date('m/d/y',strtotime('name'))." that the property was out of compliance with the community rules and regulations.",0,'0',false);
$pdf->WriteHTML("<br><b> This violation specifically regards the following item(s): ".'name'."</b>. It was noted that this violation occurred in the following location: ".'name'.".<br><br>The Governing Documents, specifically<b> Rules and Regulations, Section 5.13 (3) </b>of the Declaration of Covenants, Conditions, and Restrictions (Deed Restrictions) for Stoneridge Square Association states, in part:");
$pdf->Ln();
