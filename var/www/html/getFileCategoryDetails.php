...
if ( $parseJSON[0]->type == "legal" ){
     ...
     $secondQuery = "SELECT * FROM community_disclosures where type_id=(select id from disclosure_type where name = '".$parseJSON[0]->sub_category."') and community_id =".$parseJSON[0]->community_id;
     echo $secondQuery;
