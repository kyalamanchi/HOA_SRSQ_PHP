...
if ( $homeID < 144 ) {
	$mailingData = array("key" => $m_api_key_2, "message" => array("html" => "<center><img src=\"cid:".$mandrill_cid."\" alt=\"Community Logo\"></center><br><b>Inspection Notice for  ".$address."</b><br><br>Hello ".$name.",<br><br>Here is your inspection notice.<br><br>If you feel that your are not getting timely responses to your inspection  inquiries please escalate to board@stoneridgeplace.org<br><br>Update your contact your information <a href=\"https://hoaboardtime.com\">here.</a><br><br>In case you missed it, here is recent <a href=\"https://hoaboardtime.com/bloggy.php\">communication</a>","subject" => $subject,"from_email" => $fromCommunityEmail1,"from_name" => $legalName,"to" => array(array("email"=>$email,"name"=>$name)),"improtant"=>"true","track_opens" => "true","track_clicks" => "true","attachments" => array(array("type" => "application/pdf","name" => "inspection_notice.pdf","content" => $fileContents)),"images"=>array( array("type" => "image/jpg","name" => $mandrill_name,"content" => $communityLogo) ),"send_at"=>"2000-01-01 00:00:00"));
}

else if ( $homeID < 287 ){
$mailingData = array("key" => $m_api_key_3, "message" => array("html" => "<center><img src=\"cid:".$mandrill_cid."\" alt=\"Community Logo\"></center><br><b>Inspection Notice for  ".$address."</b><br><br>Hello ".$name.",<br><br>Here is your inspection notice.<br><br>If you feel that your are not getting timely responses to your inspection  inquiries please escalate to board@stoneridgeplace.org<br><br>Update your contact your information <a href=\"https://hoaboardtime.com\">here.</a><br><br>In case you missed it, here is recent <a href=\"https://hoaboardtime.com/bloggy.php\">communication</a>","subject" => $subject,"from_email" => $fromCommunityEmail2,"from_name" => $legalName,"to" => array(array("email"=>$email,"name"=>$name)),"improtant"=>"true","track_opens" => "true","track_clicks" => "true","attachments" => array(array("type" => "application/pdf","name" => "inspection_notice.pdf","content" => $fileContents)),"images"=>array( array("type" => "image/jpg","name" => $mandrill_name,"content" => $communityLogo) ),"send_at"=>"2000-01-01 00:00:00"));
}
