					...
					<div class='container'>
						...
						<div class='row'>
							...
							<div class='col-md-4 offset-md-4'>
								...
								<div class='up-form'>
									...
									<form method='post' action=''>
										...
										<div class='form-group'>
											...
											<input class='form-control form-control-lg' type='email' name='reset_email' id='reset_email' placeholder='Email' required>
								...
								<div class='up-help'><a href='login_page.php'>Back to Sign In page</a></div>
