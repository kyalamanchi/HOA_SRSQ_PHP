...
$url = 'https://content.dropboxapi.com/2/files/upload';
    ...
    curl_setopt($ch, CURLOPT_HTTPHEADER, array('Authorization: Bearer xCCkLEFieJAAAAAAAAABUHpqfAcHsr24243JwXKp_A6jK_cKpN-9IFdm8QxGBjx9','Content-Type:application/octet-stream','Dropbox-API-Arg: {"path": "/'.$inspectionHOAID.'-'.$inspectionHomeID.'-'.$inspectionDateFinal.'.pdf","mode": "overwrite","autorename": true,"mute": false}'));
