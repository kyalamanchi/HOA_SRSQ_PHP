...
$pdf->SetFont('','B',9);
$pdf->MultiCell(0,3.5,"\n\nRE: ".$re[0]."-".$inspectionSubCategoryNameFinal." ",0,'0',false);
$pdf->SetFont('','',9);
...
$url = 'https://content.dropboxapi.com/2/files/upload';
    ...
    curl_setopt($ch, CURLOPT_HTTPHEADER, array('Authorization: Bearer xCCkLEFieJAAAAAAAAABUHpqfAcHsr24243JwXKp_A6jK_cKpN-9IFdm8QxGBjx9','Content-Type:application/octet-stream','Dropbox-API-Arg: {"path": "/'.$inspectionHOAID.'-'.$inspectionHomeID.'-'.$id.
