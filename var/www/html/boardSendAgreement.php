                      ...
                      <?php
                        ...
                        while ($row = pg_fetch_assoc($result)) {
                          ...
                          if ($email != "")
                          {
                            ...
                            echo "<tr><form method='POST' action='https://hoaboardtime.com/boardSendAgreement2.php'><td><input type='hidden' name='name' id='name' value='".$name."'>".$name."</td><td><input type='hidden' name='hoa_id' id='hoa_id' value='".$hoa_id."'>".$hoa_id."</td><td><input type='hidden' name='living_in' id='living_in' value='".$living_in."'>".$living_in."</td><td><input type='hidden' name='home_id' id='home_id' value='".$home_id."'>".$home_id."</td><td><input type='hidden' name='email' id='email' value='".$email."'><button class='btn btn-link'>".$email."</button></td><td>".$cell_no."</td></form></tr>";

                          }
                          else
                            echo "<tr><td>".$name."</td><td>".$hoa_id."</td><td>".$living_in."</td><td>".$home_id."</td><td>".$email."</td><td>".$cell_no."</td></tr>";
