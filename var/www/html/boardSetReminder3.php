                ...
                <div class="box-body">
                  ...
                  <?php 
                    ...
                    if(!$result)
                    {
                      ...
                      echo "<center>An error occured while creating reminder.Plese try again</center><br><br>";

                      echo "<br><br><center><a href='https://hoaboardtime.com/boardSetReminder.php'>Click here</a> if this page doenot redirect automatically in 5 seconds.</center><script>setTimeout(function(){window.location.href='https://hoaboardtime.com/boardSetReminder.php'},4000);</script>";

                    }
                    else 
                    {
                      
                      echo "<center>Reminder created successfully.Page will auto redirect to reminders page.</center>";

                      echo "<br><br><center><a href='https://hoaboardtime.com/boardViewReminders.php'>Click here</a> if this page doenot redirect automatically in 5 seconds.</center>
                                <script>setTimeout(function(){window.location.href='https://hoaboardtime.com/boardViewReminders.php'},4000);</script>";
