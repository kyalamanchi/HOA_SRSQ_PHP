														...
														<?php 
		                        							...
		                        							while($row = pg_fetch_assoc($result))
		                        							{
		                          								...
		                          								for($k = 0; $k < $i; $k++)
		                          								{
		                          									...
		                          									if($person_emails[$k] == $document_to)
		                          										echo "<tr><td><a title='Click to sign agreement' target='_blank' href='https://hoaboardtime.com/esignPreview.php?id=$agreement_id'>$agreement_name</a></td><td>$document_to</td><td>$create_date</td><td>$send_date</td><td>$last_updated</td></tr>";
